	        	...
	        	if(json.length > 0) {   
	        		$.each(json, function(index, item){ 
	        			 ...
	        			 */
	        			 ...
	        			 html +=  "<div> "+item.cmt_passwd+"</div>"
	                         + "<div class='customDisplay'>"+item.fk_qna_num+"</div>"      
	                         + "<div class='customDisplay'>"+item.cmt_contents+"</div>";
